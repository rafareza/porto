# 9f8eb3ee-f234-4737-a5bd-6a1bf110bc15 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `portfolio.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `portfolio.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `portfolio.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `prd.md`
- `screenshot-2026-09-09T03-18-04-643Z.png`

## Coding checklist for AI tools
1. Inspect `portfolio.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
